var saltykeys = require('../index.js');

var mnemonic = saltykeys.prototype.generateRandomMnemonic();
var seed = saltykeys.prototype.generateSeed(mnemonic);
var keys = saltykeys.prototype.generateKeyPair(seed);
...
console.log("\nRandom Mnemonic : ", mnemonic);
console.log("\nRandom Seed : ", seed);
console.log("\nSeed Length : ", seed.length);
console.log("\nPrivate Key : ", keys.privateKey);
console.log("\nPrivate Key Length : ", keys.privateKey.length);
console.log("\nPublic Key : ", keys.publicKey);
console.log("\nPublic Key Length : ", keys.publicKey.length);

var message = "This is a signed message";

var signatureTender = saltykeys.prototype.sign(keys.privateKey, message);
console.log("\nTndrKys SignMsg: ", signatureTender.toString('hex').toUpperCase());
console.log("\n");
